...
import com.shtoone.aqxj.adapter.OrganizationTreeListViewAdapter;
import com.shtoone.aqxj.bean.DepartmentData;
import com.shtoone.aqxj.bean.OrganizationActivityData;
import com.shtoone.aqxj.bean.OrganizationBean;
...
//        }
    ...
    public String createRefreshULR() {
        ...
        if (type.equals("3")){
            return URL.getOrganizationData3(dateTime, userGroupID, mUserRole);
        }
    ...
    private void setViewData() {
        ...
        mAdapter.setOnTreeNodeClickListener(new TreeListViewAdapter.OnTreeNodeClickListener() {
            ...
            public void onClick(Node node, int position) {
                if (getIntent().getStringExtra("newedite")!=null) {
