...
import com.shtoone.aqxj.bean.EnterPoundsDetailData;
...
public class EnterPoundsQueryDetailActivity extends BaseActivity {
    ...
    private TextView tvProvider, tvWaag, tvWeighman, tvEnterTime, tvPlayTime, tvSilo, tvPici, tvOrderNo, tvPlate, tvRemark,tvshifouhege,tvbangdanhao;//基本信息
    ...
    private void initView() {
        ...
        tvshifouhege = (TextView) findViewById(R.id.shifouhege);//
        tvbangdanhao = (TextView) findViewById(R.id.bangdanhaohao);//
